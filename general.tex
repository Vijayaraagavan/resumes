...
\begin{rSection}{Career Objective}
    ...
    {Result-oriented and Self-driven Software Engineer with DevOps knowledge along with strong Analytical, Communication, Problem-solving, and Management Skills. Possessing 2 Years of IT expertise with various design skills including the icon animation.}
...
\begin{rSection}{Work experience}
    ...
    \begin{rSubsection}{Ardhika Software Technologies Pvt. Ltd.}{May 2022 - present}{Software Engineer}{Chennai, India}
        \item Developed the Cloud-based Restaurant PoS application.
...
\tableEnv{Technical skills}{
    \entry{Web Development}{Skilled in building responsive and interactive web applications using Vue.js framework}
    \entry{Database Management}{Proficient in designing and managing relational databases, with expertise in PostgreSQL}
    \entry{Back-end Development}{Experienced in Elixir for backend development, utilizing its concurrency and fault-tolerance features.\newline
    Skilled in Java for developing RESTful servers using spring boot, leveraging its robust ecosystem and scalability.}
    \entry{CI/CD}{Proficient in Jenkins, utilizing it for automating the build, test, and deployment processes of software projects.}
    \entry{Firebase Development}{Developed a dynamic and responsive web application using Firebase as a backend service, including database management, authentication, and hosting}
    \entry{Operating Systems}{Proficient in Linux operating systems, including Ubuntu for server deployment and maintenance.\newline
    Experienced in deploying web apps and API servers to Linux-based servers, ensuring smooth installation and configuration.}
    \entry{DevOps}{
        Proficient in containerization using Docker, facilitating consistent development and deployment environments\newline
        Familiar with Kubernetes for container orchestration and managing containerized applications in production environments
    }
     \entry{Scripting and Automation}{
        Experienced in automating tasks using Bash scripting, streamlining repetitive processes and enhancing workflow efficiency\newline
        Proficient in writing chaining requests and testing APIs using Postman, ensuring the reliability and functionality of web services
    }
    \entry{Design Tools}{
        Skilled in using Figma for designing user interfaces and creating icons\newline
        % Proficient in creating visually appealing and scalable icons for web and mobile applications
    }
