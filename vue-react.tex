...
\begin{longtable}{lp{0.7\linewidth}}
    ...
    \entry{Back-end Development}{Experienced in Elixir for backend development, utilizing its concurrency and fault-tolerance features. Skilled in Java for developing RESTful servers using Spring Boot, leveraging its robust ecosystem and scalability.} \\
    ...
    \entry{Operating Systems}{Proficient in Linux operating systems, including Ubuntu for server deployment and maintenance. Experienced in deploying web apps and API servers to Linux-based servers, ensuring smooth installation and configuration.} \\
    \entry{DevOps}{Proficient in containerization using Docker, facilitating consistent development and deployment environments. Familiar with Kubernetes for container orchestration and managing containerized applications in production environments.} \\
    \entry{Scripting and Automation}{Experienced in automating tasks using Bash scripting, streamlining repetitive processes and enhancing workflow efficiency. Proficient in writing chaining requests and testing APIs using Postman, ensuring the reliability and functionality of web services.} \\
    \entry{Design Tools}{Skilled in using Figma for designing user interfaces and creating icons.} \\
